...
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <?php if($row->question_att_file != NULL):?>
           
            <img class="img-responsive" src="<?=base_url('uploads/question/'.$row->option_att_file)?>" width="500">
        <?php endif;?>
    </div>
                ...
                <?php foreach($option as $opt):?>
                    ...
                    <?php if($opt->is_correct == 1):?>
                      <li class="text-success">
                        ...
                        <?php if($opt->option_att_file != NULL):?>
           
                            <img class="img-responsive" src="<?=base_url('uploads/question/'.$opt->option_att_file)?>" width="500">
                        <?php endif;?>

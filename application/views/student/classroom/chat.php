    ...
    $(document).ready(function(){
        ...
        $('.btn-send').click(function(){
            ...
            $.ajax({
                ...
                url         : base_url + 'student/classroom/store_chat',
        ...
        function get_chats_messages(){
            ...
            $('.chat-view').load(base_url+'student/classroom/get_chatroom',{js_uc_classroom : uc_classroom, js_uc_diklat_class : uc_diklat_class});

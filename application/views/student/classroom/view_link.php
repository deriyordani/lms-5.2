...
<div class="container-fluid">
    ...
    <div class="row mt-5 mb-5">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="mb-0 mt-3">View Link Video Conference</h1>
                    <hr class="mt-2 mb-4">
                </div>
            </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col">
                                <div class="card-body py-4">
                                    <h5 class="card-title text-teal mb-2"><?=$row->content_title?></h5>
                                    <p class="card-text mb-1">
	                                    ...
	                                    <a href="<?=$row->link?>" >
	                                     <span class="badge badge-info">Klik link ini untuk masuk</span>
	                                    </a>

	                                    <?php else:?>
	                                        <span class="badge badge-warning">Link Tidak Tersedia</span>
	                                    <?php endif;?>

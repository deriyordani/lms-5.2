...
<head>
        ...
        <title>Login Monitoring- Learning Management System Politeknik Pelayaran Sorong</title>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h3 class="font-weight-light my-4 text-center">Monitoring System</h3>
                                        ...
                                        <!-- Login form-->
                                        <form action="<?=base_url('monitoring/login/verifying')?>" method="post">

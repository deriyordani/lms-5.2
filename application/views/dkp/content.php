                                        ...
                                        <div class="modal-dialog " role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?=base_url('dkp/delete/'.$row->uc)?>" class="btn btn-danger">
                                                        Delete
                                                    </a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.btn-add').click(function(){
           ...
           $('.load-form').load(base_url+'dkp/add');
        });
        ...
        $('.btn-edit').click(function(){
           ...
           $('.load-form').load(base_url+'dkp/edit', {js_uc : uc});
        });

        $('.page-dkp a.pagination-ajax').click(function(){         
            var page    = $(this).attr('title');

            $('.load-data').load(base_url+'dkp/page', {js_page : page});

...
<div class="container">
    <div class="row">
        ...
        <div class=" col-md-8 mx-auto ">
            <?=form_open_multipart('question/update_mc')?>
            ...
            <div class="display-mc"  >
                ...
                <?php for ($i=1; $i <= 5  ; $i++):?>
                    ...
                    <div class="form-group">
                        ...
                        <input name="f_lampiran_op_old_<?=$i?>" type="hidden" value="<?=@$option[$i-1]->att_file?>" >
                        <input type="file" class="form-control" name="f_lampiran_op_<?=$i?>" accept="image/*">
                    </div>

                    <div class="form-group">
                        <input type="radio" name="f_key" value="<?=$i?>" <?=(@$option[$i-1]->is_correct == 1 ? "checked=\"checked\"" : "")?>> Kunci Jawaban
                    </div>

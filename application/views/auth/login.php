...
<head>
        ...
        <title>Login - Learning Management System Politeknik Pelayaran Sorong</title>
...
body {
  ...
  background-size: 100% auto;*/
    ...
    -->
    <body>    
        <div id="layoutAuthentication"  class="min-vh-100 position-relative" style="background: url('../assets/img/Background-LMS.jpg') repeat-y #dadada; background-position: center top;background-size: 100% auto;">
                    ...
                    <div class="container" >
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Login form-->
                                        <form action="<?=base_url('auth/verifying')?>" method="post" autocomplate="off">
                        ...
                        <div class="row ">
                            <div class="col-md-3 mx-auto">
                                <a href="<?=base_url('download/apk/elearning.apk')?>" title="Download Aplikasi Elearning Poltek Pel Sorong">
                                   <img src="<?=base_url('assets/img/icon-download.png')?>" width="90%"  >
                               </a>
                            </div>

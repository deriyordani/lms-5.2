                ...
                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <td class="text-primary text-center">Majors</td>
                            <td class="text-primary text-center">Level Majors</td>
                    ...
                    <tbody>
                        ...
                        <?php foreach($result as $row):?>
                            <tr>
                                <td><?=$no?></td>
                                <td><?=$row->label?></td>
                                <td width="10%"><?=$row->majors?></td>
                                <td width="10%"><?=$row->level_majors?></td>
                                <td width="17%">
                                        ...
                                        <div class="modal-dialog " role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?=base_url('level/delete/'.$row->uc)?>" class="btn btn-danger">
                                                        Delete
                                                    </a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.btn-add').click(function(){
           ...
           $('.load-form').load(base_url+'level/add');
        });
        ...
        $('.btn-edit').click(function(){
           ...
           $('.load-form').load(base_url+'level/edit', {js_uc : uc});
        });

        $('.page-level a.pagination-ajax').click(function(){         
            var page    = $(this).attr('title');

            $('.load-data').load(base_url+'level/page', {js_page : page});
